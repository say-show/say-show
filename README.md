...
見出し右の「曲情報」スイッチを切ると曲名などの表示が消え、カバーアートだけを並べて眺められます（PC では、切った状態でもカードにマウスを乗せるとその曲の情報が出ます）。
...
- 🖼️ カバーアート（インスパイア元の映画ポスターに切り替わります。パソコンはマウスを乗せる、スマホはタップ。スマホはもう一度タップで戻ります）
